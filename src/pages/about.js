    ...
    return(
        ...
        <div className="row">
            <div className="col-lg-12">
                ...
                <p className="text-white">SpeedForce is India’s leading chain of multi-brand two-wheeler servicing franchise. We are one of its kind across the nation. We provide innovative repair and maintenance services for any two-wheelers. With our wide range of trustworthy services like pick up and drop facility, on-road breakdown support, insurance support, Annual Maintenance Contracts, warranty program on spare parts, and lubricants we are bringing a revolution in servicing of two-wheelers. With well-equipped two-wheeler service stations and skillful mechanics, we provide quality services with excellent packages that are intended to offer you great maintenance and saving.  SpeedForce is a one-stop solution for all two-wheeler needs.
 We started in 2012 and we are growing speedily across the nation. Our franchises are  operational in 16 different states of the country and is speedily counting more. We are majorly into “ORGANISING THE UNORGANISED SECTOR” in which provide on-job training to an individual.</p>
            </div>
            </div>
        </div>
        </div>
